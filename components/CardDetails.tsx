...
import { genarateCarImageUrl } from "@/utils";
...
const CardDetails = ({ open, closeModal, car }: CarDetailsProps) => {
  return (
    <>
              ...
              >
                <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl p-6 bg-white text-left shadow-xl transition-all flex flex-col gap-5'>
                  ...
                  <div className="relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg">
                    <Image src={genarateCarImageUrl(car,'angle')} alt='Car' fill priority className='object-contain' />
